...
### AIっぽさを排除する7ルール（必須）
1. 文末を多様化：「〜です」「〜ます」が3文連続したら体言止め・問いかけ・短文で変化をつける
2. 具体性を強化：「〜と言われています」「〜と感じる方も多い」を避け、数字・場面・感情で表現する
3. 反復を禁止：同じ意味の言い換え繰り返しは削除する
4. テンポを変化：長文の後は短文を置き、リズムに波を作る
5. 根拠を添える：「おすすめ」「効果がある」には必ず「なぜなら〜」を添える
6. 主体を明示：誰の体験・意見か常に明らかにする
7. キーワードを分散：同じ単語が3文以内に2回以上出たら類語・代名詞で置き換える
