...
- 文末が「〜です」「〜ます」「〜と思います」3文以上連続している箇所は、体言止め・問いかけ・短文を交えてリズムを変える
- 「〜と言われています」「〜と感じる方も多い」など根拠の薄い曖昧表現は、具体的な数字・状況・場面に置き換える
- 同じ内容の言い換え反復（「悩む方が多い」→「悩むポイントだ」など）が見つかれば削除または統合する
- 「おすすめです」「効果があります」で終わる文には「なぜなら〜」「たとえば〜」を添える
- 同じ単語が3文以内に2回以上出現する場合は類語・代名詞で分散する
